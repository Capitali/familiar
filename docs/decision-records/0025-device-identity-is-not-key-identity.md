...
- **Status:** accepted (design) — not yet implemented. Named by the owner as the priority, 2026-07-31.
- **Date:** 2026-07-31
...
`actor = "phone:<human>"` stays as a *rendering* of the current claim, because a great deal of code and
