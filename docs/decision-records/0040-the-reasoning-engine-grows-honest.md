...
- **Status:** accepted — the owner, 2026-08-15, directed in the bootstrap session ("you
  should complete ADR-0040"). Every clause below was decided in the
  [design dialogue](../reviews/2026-08-14-reasoning-engine-dialogue.md) between two
  independent AI reviewers (eight questions, six rounds, per the owner's
  iterate-before-deciding protocol); the [review brief](../reviews/2026-08-14-reasoning-engine.md)
  holds the survey and
...
single-plane communication. The owner's direction: autonomous code building, observation
...
4. **Authored code begins in a language whose boundary is true by construction.** The
   ...
   *(Landed: merge d80ae4f — the external review's design.)*
5. **Truth belongs to the fixture.** A cultivated utility declares an output contract
   ...
   Extends ADR-0036 from "ran" to "was right." *(Landed: merge 26a98a0.)*
...
Belief states + narration → recipe v1 (enforced caps) → oracle
...
field calibration exists. The remaining phases were queued as proposed at
acceptance; the controller owns their sequencing and dialogue.
