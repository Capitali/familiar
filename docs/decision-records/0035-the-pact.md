...
- **Status:** retired 2026-09-10 (the owner: "I think we can remove the game screen and tests") —
...
The Pact teaches the *constitution*, with a dual intent the owner named: **test the familiar**,
