...
- **Status:** accepted — implemented 2026-08-08 (the gate, the declaration format, the
  ...
  2026-08-15 so the kernel no longer contains the first device's grammar.
  **Implemented and inert in the field** (2026-08-21, per the 2026-08-17 audit of
...
This record is that surface arriving: an already-scripted BLE LED strip becomes the first
thing in the physical world the familiar may touch — and the shape of *how* it may touch
anything is decided here, before the
