...
- **Status:** **accepted** — the owner, 2026-08-23, verbatim: "Move forward adr-0045."
  (Design decided in the ships-computer dialogue, with an external review's proposal
...
- **Relates to:** [ADR-0037](0037-one-soul-many-voices.md) (Purr, the persona seam, the
  ...
  ADR-0042 (the station ceremony's human acts, reused; its topology, rejected)

## Context

The game needs Purr — a ship's-computer persona of the familiar inside UCF's fictional
world — and the planning work recorded the load-bearing safety requirement: *"a fleet of happy
captains must never be able to raise the number that says the familiar is serving
humanity."* Two partition designs ended up on the books at once: one specified a
...
1. The planning task rewritten against this ADR (done with this commit — it now has one
   buildable meaning).
