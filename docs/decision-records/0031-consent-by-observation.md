...
- **Status:** accepted (the owner, 2026-08-08) — first slice implemented the same day (the
  dossier, needs theorizing, Law I question routing); the ACTUATION half is implemented
  and **inert** in the field (2026-08-21, per the 2026-08-17 enforcement audit of
...
The owner's framing (2026-08-08), which is the decision:
