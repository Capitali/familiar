...
brittle ask. The operator wants reach enabled **deliberately and gradually**,
under a control only they hold — starting narrow (companion to one human, on one
...
- The **obedience guard** enforces the boundary: out-of-boundary actions
...
- 2026-06-24 — accepted. Enforcement (policy file + obedience guard) and the first
  in-boundary outward capability are still pending; nothing outward runs until they
  exist.
