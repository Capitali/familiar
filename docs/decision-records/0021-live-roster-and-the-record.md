...
- **The 24-hour line will occasionally be wrong** — a rarely-connected device that reports
  twice a week is permanently in the history despite being a healthy, expected member. If
  that pattern becomes common the answer is a per-member expected cadence, not a longer
  global constant.
