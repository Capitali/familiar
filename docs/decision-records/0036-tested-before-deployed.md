...
- **Status:** accepted — implemented 2026-08-10; **inert in the field** (2026-08-21, per
  the 2026-08-17 audit of the primary live node: `allow_execute` shut —
...
IPs (`192.168.1.10/20/30` — the classic tutorial subnet, not the household's real one),
reported "No reachable devices found," and was kept in the durable
...
The owner's directive: **"assure the generated code is tested, successful, and follows the three
