...
- **Status:** proposed (the owner approved decision D6 in principle, 2026-08-15: *"I am happy
  with D6… move forward creating the proposed ADR"*; this document states the full shape
  for their acceptance). Decided across three rounds of a whole-system review dialogue
  between two independent AI reviewers, from two independent reviews.
- **Date:** 2026-08-15
...
The owner's direction (2026-08-15): the familiar *should* be able to reach agreement at the
...
7. **Consensus is a leading predictor, never the authority** (the owner, 2026-08-15, on the
   shared-lighting case; binding). A shared environmental quality — the lighting of a room
   that several people and animals all live inside — is *learned, through observation and
   adjustment.* The surface may well have an owner, a steward, and a
   ...
   **no owner of a shared surface exclusively owns the decision about its shared effects**
   (amended later — ADR-0032 declaration proves consent to expose the surface within
   ...
   **missing, never support**; a credible adverse response from an affected subject may
   ...
   - it cannot substitute for assent where assent is required — a standing rule still
     needs the explicit human yes of ADR-0032, no matter how strong the pattern;
...
(Amended in review: an earlier draft said persons were the *only interface* to humanity,
...
a later round of that dialogue, after an external review's objection):
...
**Good.** The familiar can coordinate at the scale the owner wants — many nodes agreeing on
...
- What minimal cryptographic form a "consented pseudonymous origin" takes. Bounded by
  ADR-0022's dossier constraints; specified alongside the lineage work.
