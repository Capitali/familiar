...
ADR-0019's ladder identifies a human from a device binding, a face check, or by asking. The owner's
...
For speech to be a *passive* presence signal in the way that direction requires, the microphone
