...
This SPEC restates an approved plan as testable requirements for the build loop.
...
**Acceptance criteria:**
- `docs/mesh.md`'s references to `~/Development/familiar-ios` are corrected to `~/Development/familiar-main/ios/` (the actual current worktree location).
