...
>
> The owner's direction has changed the transport. **The bespoke `/local/purr/*` endpoints below
...
{
  "name": "Mouse",
  "captain": { "callsign": "Whisker", "human_name": "Jordan" },
  "ship": {
    "name": "Longtail",
  ...
  "crew": [
    { "callsign": "Whisker", "role": "captain",  "authority": "captain", "human_name": "Jordan" },
