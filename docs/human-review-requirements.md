...
- Guard decisions (allow / seek-consent / refuse) and any human override are logged
  with rationale (planned, with the obedience guard).
- Mission-level decisions are recorded as [ADRs](decision-records/).

## Status

The obedience guard that enforces the "before acting" rows is **planned**.
