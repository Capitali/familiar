...
sequenceDiagram
    ...
    Note over A: derive + bucket:<br/>heart_rate:elevated · motion:walking<br/>gyro:turning · location:40.7,-74.0 (~100m)
    A->>F: POST /mesh/observe (signed batch · ts + nonce)<br/>actor = phone:ada / watch:ada
