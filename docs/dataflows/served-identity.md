...
*presence claim* that carries a confidence and **expires** — so "Ada is here" and "Ada
...
flowchart TD
    ...
    Verify{"2 · verify the prior 1:1<br/>(face consent on?)<br/>'should be ada — does the face agree?'"}
    Ask["3 · ask — confirm-or-correct<br/>'Is this Ada?' / 'Who's here?'"]
    ...
    Actor["device actor = phone:ada / watch:ada"]
