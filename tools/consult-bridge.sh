...
#
# Env:
#   LIGHTHOUSE     ssh target for the rendezvous host, e.g. root@lighthouse.example (required)
...
TARGET="${1:-${LIGHTHOUSE:?set LIGHTHOUSE (ssh target for the rendezvous host) or pass it as $1}}"
