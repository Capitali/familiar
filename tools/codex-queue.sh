...
CODEX="${CODEX:-/Applications/ChatGPT.app/Contents/Resources/codex}"   # wildhorse: the VS Code extension's binary under ~/.vscode/extensions/openai.chatgpt-*/bin/macos-x86_64/codex
