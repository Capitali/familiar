...
lighthouse and one workstation — the second being an accident of history this procedure exists to
end. Prefer the **lighthouse**: it is the designated holder, and keeping a user device out of the
recovery story entirely is the point. That workstation is the oldest hardware here and expected to
...
| That workstation reduced to a covenant credential | ❌ blocked on the above |
