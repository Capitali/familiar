...
final class FaceSensing: NSObject, ObservableObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    /// owner — ADR-0019 rung 1) this is a 1:1 question: "should be the owner; does the face agree?"
...
final class FaceRecognizer {
    ...
    // falls to asking. Always asking is friction nobody tolerates on a shared iPad, but searching
