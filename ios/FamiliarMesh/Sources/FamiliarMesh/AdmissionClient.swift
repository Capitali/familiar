...
/// who that is"), hold, restore. Replaces the standing vote — there is nothing to vote on any more;
...
public struct CorrectionClient {
    ...
    /// "that's not who that is" is half the record's value a year later.
    public func correct(
        subject: String,
        act: String,
        reason: String,
