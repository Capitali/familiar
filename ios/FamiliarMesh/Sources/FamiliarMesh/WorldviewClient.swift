...
///
/// The human's authorization is the authority every client follows (the owner, 2026-08-24), so a shell
...
public struct Worldview: Codable, Equatable {
    ...
    /// A console shows "asking someone else" rather than putting their question in front of
    /// whoever is holding the device. Absent from a guest projection, since it names a person.
