// JoinFailure — when every door fails, the badge says ONE sentence.
//
// The complaint, live on a handset (build 100, on 5G+): the badge under
// the `!` printed `pins 2+1 · 192.168.1.10→t:The request timed out. …` for fifteen
