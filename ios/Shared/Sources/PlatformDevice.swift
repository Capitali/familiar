...
enum PlatformDevice {
    /// The human-facing name of this machine, used as the node's roster label ("Studio iPad").
    ///
    ...
    /// bare machine name put two identically-named rows in every roster (one Mac name as a peer and
    /// the same name as a device) which read as a duplication bug rather than as the two real things
    ...
    static var name: String {
        ...
        // give "<machine>.local", which reads like plumbing.
