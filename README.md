...
*place* rather than a person — the old phone mounted on a kitchen wall, or by
the front door — and it serves whoever is there. It has no owner, and the
...
| **Lab notebook** | [experiments/](experiments/) |
