...
- STILL OPEN on this task: (1) — (2) the familiar's own MCP **server** half (`purr.say`/`purr.utterances`). (3) turning what a partner reports into observations, which wants T-205's world partition first, or a ship's stores and Betty's presence land in one log.
