...
- status: proposed — root cause supplied by Ian 2026-08-24 ("this is why we haven't been able to get it enabled on macOnStick"); nothing attempted. **Gated on MacOnStick coming back** — the machine is shut down / being repurposed (STATE 2026-08-24), so this is a note for its return, not live work
