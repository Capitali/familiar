...
- status: proposed (Ian, 2026-08-31: "we will want to be able to handle multi-load routes as soon as they are available… make sure we don't develop any blockers. Managing freight efficiently will be a key economic driver, and planning multiple types of freight over multiple stops will be necessary")
