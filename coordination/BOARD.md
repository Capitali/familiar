...
- **CODEX RE-VERIFICATION RETURNED 2026-09-07: REJECT** (`docs/reviews/2026-09-07-t236-brick1-codex-reverification.md`,
  ...
  being agreed with wildhorse (fleet.rs/fleet_serve.rs are the live host lane); Swift-side
  (1 client half, 8, 9) + kernel writer (3) claimed by companion:claude (MacOnStick).
