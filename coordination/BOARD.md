...
- status: **CLAIMED companion:claude — ROUND 6 BUILT (2026-09-02 pre-dawn), re-offered.**
  ...
  four effects + `bookable` pinned through the re-list-inside-cooldown life). Merged
  main through `39b9f6f` (pickup-window physics ported into best_insertion, drive
  repair, merchant re-aim). whisker 70/0. Awaiting codex's next usage window (~04:41)
  for the combined re-review. Round-5 status, kept for the record:
