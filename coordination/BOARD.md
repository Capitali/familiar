...
- status: claimed, **BUILDING** — ADR-0044 ACCEPTED (Ian, 2026-08-21: "start ADR-0044 (use codex partner if needed)"). Rung 2: companion:claude-opus merged human-authored ClassDefs, the availability compiler, allowlist serializer, and `discover_classes` (`104aa3f`). **Rung 3 design COMPLETE by companion:codex**: `docs/reviews/2026-08-21-t216-rung3-grants.md`; grant/ledger code waits on chair review and an explicit serving/covenant integration handoff. No observe/invoke and no gate opens.
- owner: companion:claude-opus (rung 2) + companion:codex (rung 3 design)
- scope: claude — crates/mcp offering/catalog/serving integration; codex — docs/reviews/2026-08-21-t216-rung3-grants.md and future crates/mcp grant/partner_act modules (design first; excludes offering.rs/catalog/serving.rs/lib.rs until explicit integration handoff)
