...
- scope: claude — crates/mcp/src/offering.rs; codex — docs/reviews/2026-08-21-t216-rung3-grants.md, crates/mcp/src/{partner,grant,partner_act,server,covenant,lib}.rs and crate-local tests; human grant-decision CLI/console is a later contract
