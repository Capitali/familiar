...
- status: proposed (Ian, 2026-09-02, verbatim: "when trading, are we planning routes between our ships to deliver goods to processing facilities and haul the resulting cargo -- our plans looking forward should utilize this information in p&L maximization routines." — sent with the Cannery Row works screen: lines, per-cycle inputs/outputs, on-hand stocks)
