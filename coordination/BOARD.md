...
- scope: ios/Shared/Sources/AppModel.swift (phone-local device JSON only), ios/App/Sources/SphereConsoleIOS.swift (watch-state refresh + re-link bridge), ios/MacApp/Resources/sphere/index.html Device screen
- depends: —
