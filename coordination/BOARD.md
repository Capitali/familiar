...
- status: proposed — filed 2026-08-24 on Ian's target-audience ruling (STATE standing directions, verbatim: "Ios/macos/ipados/watchos with as much apple intelligence enabled as possible"). The survey below is DONE and grounded in the tree; the build is not started
- owner: —
...
- status: **CEREMONY EXECUTED 2026-08-23 01:19:40 UTC — the Envoy is principal
  ...
  outcomes + ceremony narrative) — trail in DEVELOPMENT_LOG 2026-08-23 and STATE. Ian's
  recorded position that registration should be automatic is a standing chair question,
  not applied. Brick 1's identity-probe blocker remains open on its own track.
