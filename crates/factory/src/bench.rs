...
/// (2026-09-05: four factory tests red on a Mac without Homebrew
...
pub fn find_python() -> Option<PathBuf> {
    // Homebrew on Apple Silicon, then on Intel (an Intel Mac keeps its
...
mod tests {
    ...
    /// (found by an external review, on the red parallel bar).
