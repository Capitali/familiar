...
//!
//! Until now the familiar asked and the owner answered. This is the other direction: a person
//! poses a free-form request ("do I have network-config issues?"), the cycle analyzes it, and
