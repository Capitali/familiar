//! Belief states derived from prediction evidence (ADR-0040 §3).
//!
...
/// Apply the typed override exception. `evidence_id` makes replay idempotent; `line`
...
mod tests {
    ...
    fn human_correction_and_hard_reversal_bypass_the_sample_floor_idempotently() {
        ...
        let reversal = apply_override(
            ...
            "act-reversal",
            "The owner undid the light change",
            200,
        )
        .unwrap()
        .unwrap();
    ...
    fn narration_keeps_counts_both_citations_priority_and_cooldown() {
        ...
        apply_override(
            ...
            OverrideKind::HumanCorrection,
            "correction",
            "The owner said presence was not the cause",
            100,
        )
        .unwrap();
        apply_override(
            ...
            OverrideKind::HardActReversal,
            "reversal",
            "The owner restored the prior light level",
            101,
        )
        .unwrap();
