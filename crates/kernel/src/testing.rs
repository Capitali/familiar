//! **Test fixture roots that cannot collide.**
//!
//! Observed 2026-08-14: a full green-bar run overlapped another session's
...
//! and this repo runs several worktrees at once by design.
//!
