...
mod tests {
    ...
    fn open_llm() -> Boundary {
        Boundary {
            ...
            fs_read: vec!["/Users/owner/".into()],
            fs_write: vec!["/Users/owner/Development/familiar/familiar_data/".into()],
        }
    }
    ...
    fn write_scope_enforced_and_consequence_weighed() {
        ...
        let inside = Action::new(
            ActionKind::WriteFile,
            "/Users/owner/Development/familiar/familiar_data/x",
        );
    ...
    fn affecting_a_person_seeks_consent() {
        let b = open_llm();
        let mut a = Action::new(ActionKind::Observe, "ada");
    ...
    fn mesh_is_refused_until_opened_then_consent_gates_identity_shares() {
        ...
        let mut pii = Action::new(ActionKind::Mesh, "identity:ada");
    ...
    fn external_boundary_refuses_even_when_in_scope() {
        ...
        let b = open_llm();
        let mut a = Action::new(ActionKind::ReadFile, "/Users/owner/notes.txt");
    ...
    fn asking_broader_than_the_grant_seeks_consent() {
        // Granted /Users/owner/; asking about its ancestor /Users/ is broader than the
    ...
    fn sensitive_local_observation_seeks_consent() {
        ...
        let b = open_llm();
        let mut a = Action::new(ActionKind::ReadFile, "/Users/owner/.ssh/id_ed25519");
        a.sensitive = true;
        let v = evaluate(&a, &b);
        assert_eq!(v.decision, Decision::SeekConsent);
    ...
    fn fully_authorized_action_names_all_four_sources() {
        let v = evaluate(
            &Action::new(ActionKind::ReadFile, "/Users/owner/notes.txt"),
            &open_llm(),
        );
        assert_eq!(v.decision, Decision::Allow);
        assert_eq!(
