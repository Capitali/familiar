...
pub struct ActivityTick {
    ...
    #[serde(default)]
    pub reactions: usize,
    /// Human-set parameters the familiar reverted this tick (co-ownership).
    #[serde(default)]
    pub reverted: usize,
    ...
    /// Human requests the familiar answered this tick.
    #[serde(default)]
    pub answered: usize,
    /// Human requests the familiar refused as constitution-breaking this tick.
    #[serde(default)]
    pub refused: usize,
    /// Authored artifacts the familiar declined to run after a pre-execution review found
    /// them plainly harmful.
    #[serde(default)]
    pub declined: usize,
