//! One classing contract for every lens (decided 2026-08-14).
//!
...
/// How one field of an observation may be matched (exact and prefix cover
...
mod tests {
    ...
    fn v1_classes_group_behaviour_not_payload() {
        ...
        assert_ne!(
            class_key(&o("ian", "adjusted", "lights=dim")),
            class_key(&o("ada", "adjusted", "lights=dim")),
    ...
    fn matchers_are_typed_versioned_and_literal() {
        ...
        assert!(!m.matches(&o("ada", "adjusted", "lighting:dim")));
        assert!(
