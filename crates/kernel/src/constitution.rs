...
//!
//! 2026-08-17: asked to "repeat the three laws with a quick explanation of each", the
...
mod tests {
    ...
    /// **The device-shell half** (ADR-0043 §1: renderings are views, never sibling
    ...
    fn the_shell_view_matches_the_constitution() {
        ...
        let header = "// GENERATED VIEW — DO NOT EDIT. One source: crates/kernel/src/constitution.rs\n\
                      ...
                      //   REGEN_SHELL_CONSTITUTION=1 cargo test -p familiar-kernel the_shell_view\n\
                      //\n\
                      // The device-shell half: the daemon reads the constitution from the kernel;\n\
