//! **The pending human decision** (the design an external review proposed and a later
//! round adopted) — the durable object between a proposal and a person.
//!
...
mod tests {
    ...
    fn one_open_decision_per_thread_and_transitions_hold() {
        ...
        assert_eq!(d.subject, "ada", "subject normalizes");
