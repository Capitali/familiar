...
//!
//! The owner, 2026-08-18: *"We should expose it and make it ready for the partner's agent to
//! reach it."* This module is the shape that request takes without becoming an open door.
//!
