...
/// The protocol revision this client speaks. `ucf-exchange` answered on this one when the
/// client first probed it (2026-08-16); a server that negotiates a different revision is
...
mod annotation_tests {
    ...
    /// the live example the exchange's schema describes.
    #[test]
