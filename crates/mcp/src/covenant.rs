...
//! *"not available until you have accepted the Three Laws"* — the same shape the exchange
...
//! partner, and it exists because the owner asked for it in those terms (2026-08-18): *"get
//! the partner's agent to agree to the familiar's three laws for all our interactions."*
//!
