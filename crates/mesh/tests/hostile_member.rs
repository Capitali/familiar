//! Deterministic multi-node proof fixture used by the hostile-member containments.
...
/// Containment: a valid member and replay cannot turn an unmatched assertion into local
...
/// Containment: a far-future member clock proves provenance, never rewrite authority.
#[test]
