...
pub struct MemberStatus {
    ...
    /// Relayed through the status directory so a device reaching the mesh only via
...
mod tests {
    ...
    fn records_and_expires_a_members_status() {
        ...
        let (mut report, gl) = a_report(&home, "wrong", "ipad:ada");
        ...
        assert_eq!(stored.present_human, "ada");
