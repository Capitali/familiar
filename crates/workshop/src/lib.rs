//! The workshop — the familiar's dark-factory management core.
//!
...
//! for the human's declaration. This crate owns what the design dialogue
//! assigned to it and nothing more:
//!
