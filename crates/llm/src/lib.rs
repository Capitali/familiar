...
/// its mind. It had reached it every time.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
enum Expect {
...
/// [`consult_human`] for a **typed** human-lane act: same queue priority, same
...
fn consult_in(
    ...
    let mut child = Command::new("sh")
        ...
        // The lane travels with the consult. `Lane` already decides who goes NEXT —
